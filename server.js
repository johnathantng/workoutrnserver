...
app.get('/profile/:id/meals', (req, res) => { meal.handleMealGet(req, res, db) });
app.get('/profile/:id/meals/:meal_id', (req, res) => { meal.handleMealIdGet(req, res, db) });
app.put('/profile/:id/meals/:meal_id', (req, res) => { meal.handleMealUpdate(req, res, db) });
app.delete('/profile/:id/workouts/:workout_id', (req, res) => { workout.handleWorkoutDelete(req, res, db) });
app.delete('/profile/:id/meals/:meal_id', (req, res) => { meal.handleMealDelete(req, res, db) });
...
app.post('/profile/:id/meals/:meal', (req, res) => { meal.handleMealCreate(req, res, db) });
